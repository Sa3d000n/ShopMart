    ...
    <div className="container py-16">
      ...
      <div className=" text-center mt-12">
        <button
          ...
          class=" cursor-pointer group relative inline-flex items-center overflow-hidden rounded-full bg-primary-color px-8 py-3 text-white focus:ring-3 focus:outline-hidden transition-colors duration-300 hover:bg-sky-600"
          href="#"
        >
