...
import heroImage from "../../assets/heroSection/market.png";
const IntroSection = () => {
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-24">
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-stone-600 mb-8 lg:mb-0">
           Shop the latest trends and timeless classics from top brands around the world
            with unbeatable prices, premium quality, and lightning-fast delivery to your doorstep
          </p>
        </div>
